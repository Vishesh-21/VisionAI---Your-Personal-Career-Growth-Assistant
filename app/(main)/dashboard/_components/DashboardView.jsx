  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
        <Card>
          <CardHeader
            className={"flex items-center flex-row justify-between space-y-0"}
          >
      ...
      {/* showing other states  */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            <CardTitle>Key Industry Trends</CardTitle>
            <CardDescription>
              Current trends shading the industry
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Skills to be consider developing</CardDescription>
          </CardHeader>
          <CardContent>
            <ul className="flex flex-wrap gap-2">
              {insights.recommendedSkills.map((skill, index) => (
                  <Badge key={index} variant={'outline'} className="text-sm space-x-2">{skill}</Badge>
              ))}
            </ul>
          </CardContent>
        </Card>
