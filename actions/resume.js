...
export async function improveWithAI({ current, type }) {
  ...
  3. Highlights relevant technical skills
  4. Keep it concise but detailed
  5. Focus on achievements over responsibilities
  6. Use industry-specific keywords
  
  formate the response as a single paragraph without any additional text or explanations.`;
  ...
  try {
    ...
    throw new Error("Failed to improve the content");
  }
}
